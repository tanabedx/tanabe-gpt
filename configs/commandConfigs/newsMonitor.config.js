const { EVALUATE_TWEET, EVALUATE_ARTICLE, BATCH_EVALUATE_TITLES, BATCH_EVALUATE_FULL_CONTENT, SUMMARIZE_CONTENT, SITREP_artorias_PROMPT, PROCESS_SITREP_IMAGE_PROMPT } = require('../../prompts/newsMonitor.prompt');
