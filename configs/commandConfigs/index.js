...
const {
    // TWITTER_DEBUG_CONFIG, // Removed
    // RSS_DEBUG_CONFIG,     // Removed
    // NEWS_STATUS_CONFIG,   // Removed
    NEWS_TOGGLE_CONFIG,
...
const PERIODIC_SUMMARY_CONFIG = require('./periodicSummary.config');
...
const COMMANDS = {
    ...
    // TWITTER_DEBUG: TWITTER_DEBUG_CONFIG, // Removed
    // RSS_DEBUG: RSS_DEBUG_CONFIG,         // Removed
    // NEWS_STATUS: NEWS_STATUS_CONFIG,     // Removed
    NEWS_TOGGLE: NEWS_TOGGLE_CONFIG,
    DEBUG_PERIODIC: DEBUG_PERIODIC_CONFIG,
    CACHE_CLEAR: CACHE_CLEAR_CONFIG,
    CONFIG: CONFIG_CONFIG,
    CACHE_RESET: CACHE_RESET_CONFIG,
    CACHE_STATS: CACHE_STATS_CONFIG,
    PERIODIC_SUMMARY: PERIODIC_SUMMARY_CONFIG,
    NEWS_DEBUG: NEWS_DEBUG_CONFIG,
};
